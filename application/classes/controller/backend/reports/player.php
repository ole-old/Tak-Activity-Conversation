...
class Controller_Backend_Reports_Player extends Controller_Backend_Template {
	...
	public function action_index()
	{
		...
		$free_text = Arr::get($_GET, 'free_text', '');
		...
		$params = array('free_text' => $free_text, 'state_id' => $state_id, 'developer_id' => $developer_id, 'game_id' => $game_id, 
		...
		public function action_report()
	{
		...
		$this->template->content = $view;
			...
			header('Content-Disposition: attachment; filename=Reporte_jugadores_'.date('Y-m-d-H-i-s').'.xls');
