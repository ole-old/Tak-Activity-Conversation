    ...
    <div id="tak_juegocontenido" class="tak_contenido">
    	<div class="tak_fondojuegos">
				...
				<div id="tak_otroboton" class="tak_regresar_favoritos">
                    ...
                    <!--<a class="tak_agregarfavorito" href="#" id="game_info">Prueba</a> -->
...
//				});
			...
			<script type="text/javascript" charset="utf-8">
				$(document).ready(function(){
					...
					$("#game_info").click(function(e){
						e.preventDefault();
						console.log("antes");
						setGameInfo('inicio del juego',50,'inicioJuego');
						setGameInfo('cambio del juego',50,'cambioEscena');
						setGameInfo('información del juego',50,'salvarInfo');
						setGameInfo('fin del juego',50,'finJuego');
					});
