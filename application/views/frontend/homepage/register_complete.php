...
/* Form validation */
	$("form.validate").submit(function(){
		...
		if( $('#terms2').attr('checked') || $('#terms3').attr('checked') ){
				...
				alert('Debes aceptar que eres mayor de edad o tienes el consentimiento de tus padres');
				$(this).focus();
				error = true;
				return false;
			}
  ...
  <div id="mycarousel" class="jcarousel-skin-tango">
	...
	<div class="tak_contenido">
        <div class="tak_registro">
            ...
            <p>Para jugar es necesario que llenes la siguiente información. Al terminar haz  click en Guardar datos.</p>
			...
			<h2>Llena los datos</h2>
                <ul> 
							...
							<li>Leí y estoy de acuerdo con los términos y condiciones del <b>Aviso de privacidad</b>, y de la protección y uso de mis datos.</li>
							<li>Si eres menor de edad, necesitas el consentimiento de tus papás o tutores.</li>
                </ul>
                <div>
                <form id="frm_register" action="completa_registro" method="post" class="validate">
                      ...
                      <table class="tak_ninonina" width="100%" border="0" cellspacing="0" cellpadding="0">
					 	<tr>
							<td colspan="4">
                             <a  class="siavatar" href="javascript:void(0);">Sí </a>
							</td>
					  </tr>
                      <tr>
                      	<td>
                        	<table style="margin-top: 20px;">
                            	<tr>
                                	<td><input type="checkbox" name="terms" value="1" class="required_checkbox" alt="Acepte el aviso de privacidad"></td>
                                    <td>Sí, <a href="javascript:void(0);" class="terms" style="color: #555555; text-decoration: underline;">Ver aviso de privacidad</a></td>
                                </tr>
                            </table>
                            <table style="margin-top: 90px;">
                            	<tr>
                                	<td><input type="radio" id="terms2" name="terms2" value="1" alt="Tengo el consentimiento de mis papás o tutores"></td>
                                    <td>Tengo el consentimiento de mis papás o tutores</td>
                                </tr>
                            	<tr>
               ...
               <audio id="beep-trhee" controls="controls" preload="auto">
				...
				<script>$(".tak_guardar_avatar,.tak_registrate2, .siavatar, .no_avatar")
				  .each(function(i) {
					if (i != 0) { 
					  $("#beep-trhee")
						.clone()
